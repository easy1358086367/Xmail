                    ...
                    <div class="full">
                      ...
                      <div class="nav-cart-total">
                        ...
                        <h5>
                          合计：
                          <span class="price-icon">¥</span>
                          <span class="price-num">{{cartPrice}}</span>
                        </h5>
                        <h6>
                          <el-button type="danger" style="width:100px;height:30px">去购物车</el-button>
                        </h6>
                      </div>
                    </div>
                    <div style="height: 313px;text-align: center" class="cart-con" v-show="cartNum == 0" >
                      <p>您的购物车竟然是空的!</p>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  async mounted() {
    if(this.login){
      let res = await this.$axios.post(path.cartList,{userId:getStore('id')})
      if(res.data.code == 200){
        setStore('buyCart',res.data.carList)
      }
    }
